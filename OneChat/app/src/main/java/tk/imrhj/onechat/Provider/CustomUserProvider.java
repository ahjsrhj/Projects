package tk.imrhj.onechat.Provider;
...
public class CustomUserProvider implements ThirdPartUserUtils.ThirdPartDataProvider {
    ...
    static {
        partUsers.add(new ThirdPartUserUtils.ThirdPartUser("Tom", "Tom", avatarList[0]));
        partUsers.add(new ThirdPartUserUtils.ThirdPartUser("rhj", "rhj", avatarList[0]));
        for (int i = 0; i < 36; i++) {
